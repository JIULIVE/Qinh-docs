> 上一页：[API概览.md](API概览.md)　·　下一页：[脚本API.md](脚本API.md)
> 相关：[API概览.md](API概览.md) · [脚本API.md](脚本API.md) · [../02-服主指南/物品源引用.md](../02-服主指南/物品源引用.md) · [../03-外部插件对接/物品类插件.md](../03-外部插件对接/物品类插件.md)
...
引用字符串语法（`源:物品ID`、JSON 参数等）见 [../02-服主指南/物品源引用.md](../02-服主指南/物品源引用.md)；统一物品源接了哪些外部插件见 [../03-外部插件对接/物品类插件.md](../03-外部插件对接/物品类插件.md)。
...
完整的引用语法（分隔符、JSON 参数、原版材料回退等）见 [../02-服主指南/物品源引用.md](../02-服主指南/物品源引用.md)。
...
- [脚本API.md](脚本API.md) —— 脚本里也能 `qcl.itemParse` / `qcl.itemGive` 取物。
- [经济API.md](经济API.md) —— 配合取物做收费发奖。
- [../02-服主指南/物品源引用.md](../02-服主指南/物品源引用.md) —— 引用字符串完整语法。
- [../03-外部插件对接/物品类插件.md](../03-外部插件对接/物品类插件.md) —— 内置接了哪些外部物品源。
