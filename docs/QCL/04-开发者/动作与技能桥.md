> 相关：[API概览.md](API概览.md) · [脚本API.md](脚本API.md) · [条件与表达式.md](条件与表达式.md) · [../05-参考/术语表.md](../05-参考/术语表.md)
...
- [条件与表达式.md](条件与表达式.md) —— 与动作搭配的条件判断 / 表达式求值
- [脚本API.md](脚本API.md) —— 脚本化扩展
- [API概览.md](API概览.md) —— QCL 对外 API 全貌
- [../05-参考/术语表.md](../05-参考/术语表.md) —— QI / QS / handler / payload / trigger 等术语定义
