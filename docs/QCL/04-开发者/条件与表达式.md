> 相关：[动作与技能桥.md](动作与技能桥.md) · [API概览.md](API概览.md) · [脚本API.md](脚本API.md) · [../05-参考/术语表.md](../05-参考/术语表.md)
...
动作要「做什么」，条件决定「做不做」；表达式则给动作算出具体数值。三者通常一起用，见 [动作与技能桥.md](动作与技能桥.md)。
...
- [动作与技能桥.md](动作与技能桥.md) —— 动作系统与跨模块技能契约
- [脚本API.md](脚本API.md) —— 脚本化扩展能力
