> 上一页：[物品API.md](物品API.md)　·　下一页：[经济API.md](经济API.md)
> 相关：[API概览.md](API概览.md) · [物品API.md](物品API.md) · [经济API.md](经济API.md) · [../02-服主指南/脚本入门.md](../02-服主指南/脚本入门.md)
...
服主向的脚本写法入门见 [../02-服主指南/脚本入门.md](../02-服主指南/脚本入门.md)。
...
- [经济API.md](经济API.md) —— 脚本里 `qcl.economyHas/Withdraw/Deposit` 背后的完整经济门面。
- [物品API.md](物品API.md) —— `qcl.itemParse/itemGive` 背后的物品门面。
- [../02-服主指南/脚本入门.md](../02-服主指南/脚本入门.md) —— 服主向脚本写法。
