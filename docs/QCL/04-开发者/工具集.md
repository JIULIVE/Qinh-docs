...
> 导航：[文档首页](../README.md) · [目录](../README.md) · [API 概览](API概览.md) · [模块系统](模块系统.md) · [术语表](../05-参考/术语表.md)
...
- [API 概览](API概览.md) — 对外 API 的整体地图
- [模块系统](模块系统.md) — Module / ModuleManager / 诊断模型
- [术语表](../05-参考/术语表.md) — 名词解释
