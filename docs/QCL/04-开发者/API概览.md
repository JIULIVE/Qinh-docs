> 上一页：[../03-外部插件对接/经济插件.md](../03-外部插件对接/经济插件.md)　·　下一页：[物品API.md](物品API.md)
> 相关：[物品API.md](物品API.md) · [脚本API.md](脚本API.md) · [经济API.md](经济API.md) · [../03-外部插件对接/物品类插件.md](../03-外部插件对接/物品类插件.md) · [../05-参考/术语表.md](../05-参考/术语表.md)
...
- [物品API.md](物品API.md) —— `ItemManagerAPI` 全方法、`ItemModule` 实现、Groovy 外部物品模块、物品元数据读写。
- [脚本API.md](脚本API.md) —— `QinhScriptBridge` / `qcl` / `ctx`、从宿主调脚本传变量、沙箱。
- [经济API.md](经济API.md) —— `EconomyBridge` 全方法、三后端差异、错误码处理。
- [../03-外部插件对接/物品类插件.md](../03-外部插件对接/物品类插件.md) —— 统一物品源接的是哪些外部物品插件。
