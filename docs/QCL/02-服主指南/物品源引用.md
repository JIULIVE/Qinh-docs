> 上一页：[命令与权限](命令与权限.md)　·　下一页：[诊断与排错](诊断与排错.md)
...
## 📖 继续阅读
- ➡️ 下一页：[诊断与排错](诊断与排错.md) — 引用失败时如何排查
- 🔗 [物品API](../04-开发者/物品API.md) — `ItemManagerAPI.getHookItem(ref)` 等接口
- 🔗 [外部插件对接 · 物品类插件](../03-外部插件对接/物品类插件.md) — 各物品插件接入说明
