> 上一页：[GUI动作与条件速查.md](GUI动作与条件速查.md) · 下一页：[脚本入门.md](脚本入门.md)
> 相关：[自定义GUI.md](自定义GUI.md) · [配置文件.md](配置文件.md) · [经济API.md](../04-开发者/经济API.md) · [经济插件.md](../03-外部插件对接/经济插件.md)
...
GUI 基础结构见 [自定义GUI.md](自定义GUI.md)，经济系统的全局配置见 [配置文件.md](配置文件.md) 的 `economy` 段。
...
## 📖 继续阅读
- ⚙️ [配置文件.md](配置文件.md) — `economy` 配置段（默认 provider、开关）
- 🖼️ [自定义GUI.md](自定义GUI.md) — 经济动作所在的 GUI 结构
- 🔎 [GUI动作与条件速查.md](GUI动作与条件速查.md) — 配合 `money` 显隐条件做购买按钮
- 🧰 [经济API.md](../04-开发者/经济API.md) — 开发者直接调经济接口
- 🔗 [经济插件.md](../03-外部插件对接/经济插件.md) — 对接 Vault / PlayerPoints / ExcellentEconomy
