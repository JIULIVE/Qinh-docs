> 上一页：[物品类插件.md](物品类插件.md)　·　下一页：[经济插件.md](经济插件.md)
> 相关：[../02-服主指南/自定义方块.md](../02-服主指南/自定义方块.md) · [../04-开发者/工具集.md](../04-开发者/工具集.md) · [概览.md](概览.md)

# 🧱 方块 / 模型 / 作物对接

除了「取物品」，QCL 还把三类**世界交互能力**接了进来：CraftEngine 的方块与家具、ModelEngine 的模型化实体、CustomCrops 的作物。它们一样遵循软依赖 + 反射桥：没装就静默不可用，绝不影响启动。

> 🧰 **共同基座**：本页所有桥的「多版本多签名兼容」都建立在 `ReflectionBridge` / `ReflectionCache` 之上 —— 同一个插件不同大版本的方法签名都能被自动找对。开发者细节见 👉 [../04-开发者/工具集.md](../04-开发者/工具集.md)。
...
CraftEngine 的物品引用（`ce-命名空间_id`）见 [物品类插件.md](物品类插件.md)。本页关注它的**方块**与**家具**能力。
...
> 服主侧如何配置自定义方块（掉落、行为等），见 👉 [../02-服主指南/自定义方块.md](../02-服主指南/自定义方块.md)。
...
开发者若要在自己代码里复用这套反射工具，见 👉 [../04-开发者/工具集.md](../04-开发者/工具集.md)。

---

## 📚 继续阅读

- 🧱 [../02-服主指南/自定义方块.md](../02-服主指南/自定义方块.md) —— CustomBlockConfig 服主配置。
- 🔧 [../04-开发者/工具集.md](../04-开发者/工具集.md) —— ReflectionBridge / ReflectionCache。
- 🎒 [物品类插件.md](物品类插件.md) —— CraftEngine / 其它插件的物品引用。
- 💰 [经济插件.md](经济插件.md) —— 三经济后端对接。
