> 上一页：[快速上手](快速上手.md)　·　下一页：[配置文件](../02-服主指南/配置文件.md)
...
> 🔢 priority 越小越先加载。基础设施（Config / Database / Reflection）排在最前，组装层（Assembly）最后。详见 [模块系统](../04-开发者/模块系统.md)。
...
> 🔌 各类第三方的具体对接见 [03-外部插件对接](../03-外部插件对接/概览.md)。
...
> 📖 完整 10 种来源的对照表与语法细节见 [物品源引用](../02-服主指南/物品源引用.md)。
...
- 健康码让排错有据可查（对照 [诊断码](../05-参考/诊断码.md)）。
...
> 👨‍💻 开发者请只依赖公开包。详见 [API概览](../04-开发者/API概览.md)。
...
- 下一页：[配置文件](../02-服主指南/配置文件.md) — config.yml 与 modules 段详解
- [模块系统](../04-开发者/模块系统.md) — Module 接口与开发
- [物品源引用](../02-服主指南/物品源引用.md) — 10 种来源完整对照
- [诊断与排错](../02-服主指南/诊断与排错.md) — 读懂健康码
- [API概览](../04-开发者/API概览.md) — 公开包 vs 内部包
