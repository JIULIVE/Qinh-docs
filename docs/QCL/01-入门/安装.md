...
能看到生态状态摘要（平台状态、健康码、模块健康等），即安装成功。详细解读见 [快速上手](快速上手.md)。
...
> 软依赖只决定「谁先加载」，保证 QCL 在它们之后能正确桥接。具体对接见 [03-外部插件对接](../03-外部插件对接/概览.md)。
...
> 🩺 排查更多问题请看 [诊断与排错](../02-服主指南/诊断与排错.md) 与 [诊断码](../05-参考/诊断码.md)。

---

## 📚 继续阅读

- 下一页：[快速上手](快速上手.md) — 装好后的第一件事
- [核心概念](核心概念.md) — 理解模块、桥、物品源
- [配置文件](../02-服主指南/配置文件.md) — config.yml 详解
