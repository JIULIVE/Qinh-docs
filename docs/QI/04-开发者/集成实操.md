...
> 所属：[开发者](API概览.md)　·　相关：[集成（架构）](集成.md) · [属性与数值](../02-服主指南/属性与数值.md) · [宝石孔](../02-服主指南/宝石孔.md)

[集成](集成.md) 讲架构，本页讲**从装到联调的完整步骤**——给服主和开发者照着接每个外部插件。
...
链接机制见 [集成 → QinhSkills](集成.md#2-qinhskills-集成)。
...
详见 [宝石孔](../02-服主指南/宝石孔.md) 与 [集成 → Legendinlay](集成.md#3-legendinlay-集成宝石孔后端-a)。
...
共用 `LegendinlayProviderParser` 解析格式。详见 [集成 → MagicGem](集成.md#4-magicgem-集成宝石孔后端-b)。
...
接入路线对比见 [API 概览](API概览.md#6-接入路线选择)。
...
- [集成（架构）](集成.md)：桥 / 注册表内部
- [API 配方集](API配方集.md)：市场 / 邮件 / 抽奖等完整代码
