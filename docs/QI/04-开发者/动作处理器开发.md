...
> 所属：[开发者](API概览.md)　·　相关：[动作系统](../02-服主指南/动作系统/概览.md) · [处理器](../02-服主指南/动作系统/处理器.md)
...
GUI 编辑流程见 [动作编辑器](../03-编辑器GUI/动作编辑器.md)。Codec 操作：
...
服主在 YAML 里组合处理器，开发者把复杂度收进处理器。这条边界让配置可被 GUI 完整编辑，见 [动作系统概览 → 设计](../02-服主指南/动作系统/概览.md#3-关键设计yaml-里不能写逻辑)。
...
- [处理器大全](../02-服主指南/动作系统/处理器.md)：内置处理器参考
- [集成](集成.md)：QinhSkills 如何作为处理器接入
