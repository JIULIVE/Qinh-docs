...
> 所属：[开发者](API概览.md)　·　相关：[属性与数值](../02-服主指南/属性与数值.md) · [集成](集成.md)
...
注册外部解析器走 `QinhIntegrationRegistry.registerExternalResolver(...)`，见 [集成](集成.md)。
...
- [集成](集成.md)：QinhSkills / Legendinlay / MagicGem 桥实例
- [层与装配](层与装配.md)：层 vs Provider 的区别
