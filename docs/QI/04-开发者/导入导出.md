...
> 所属：[开发者](API概览.md)　·　相关：[命令](../05-参考/命令.md)

QI 支持从 MMOItems / NeigeItems **导入**物品，以及把内容打包成 `.qipack` **导出 / 导入**。

> 🧭 想要**从头迁移的完整步骤 + 字段映射对照表 + dry-run 解读**？看 [导入 / 导出实操手册](导入导出实操.md)。
...
把导入映射结果转成[段](../02-服主指南/段.md) / [词缀](../02-服主指南/词缀.md)，注册进层系统。

---

## 下一步

- [命令](../05-参考/命令.md)：导入 / 导出命令完整列表
- [层与装配](层与装配.md)：层快照
