...
> 所属：[服主指南](物品定义.md)　·　相关：[物品定义](物品定义.md) · [物品类型](物品类型.md) · [动作系统](动作系统/概览.md)
...
- **[示例-装备篇](示例-装备篇.md)** —— 护甲 / 头盔 / 胸甲 / 护腿 / 靴子 / 弓 / 弩 / 三叉戟 / 弹药 / 盾牌 / 法杖 / 马铠（47 件）
- **[示例-饰品消耗篇](示例-饰品消耗篇.md)** —— 饰品 / 戒指 / 项链 / 手镯 / 食物 / 卷轴 / 种子 / 鱼饵 / 材料 / 工具 / 钓竿（41 件）
- **[示例-杂项篇](示例-杂项篇.md)** —— 货币 / 代币 / 奖杯 / 头颅 / 道具 / 坐骑（22 件）
...
需要"可把玩"的交互宝石才加 `left_click`（见 `demo_radiant_gem`）。宝石孔系统见 [宝石孔](宝石孔.md)。
...
```
> 同一个 `quality_prefix_pool` 段，`epic_sword`/`rare_sword`/`uncommon_sword` 因 tier 不同而显示不同前缀。段定义见 [段](段.md) 与 [内置内容清单](../05-参考/内置内容清单.md)。
...
```
套装定义见 [套装](套装.md) 与 [内置内容清单](../05-参考/内置内容清单.md#套装)。
...
| 左键放技能 | `demo_thunder_edge` | [动作系统](动作系统/概览.md) |
| 命中 / 击杀触发 | `demo_warden_greatsword` | [触发器](动作系统/触发器.md) |
| 喝药触发 buff | `demo_berserk_brew` | 本页 §3 |
| 卷轴 / 一次性消耗品 | `demo_recall_scroll` | 本页 §3 |
| 装备 / 卸下触发 | `demo_sunfire_emblem`（accessory） | [触发器](动作系统/触发器.md) |
| 随机前缀 / 词缀 | `random_affix_weapon` / `legendary_sword` | [段](段.md) / [词缀](词缀.md) |
| 套装 | `warrior_*` / `mage_*` | [套装](套装.md) |
| 绑定物品 | `demo_warden_greatsword` | [灵魂绑定](灵魂绑定.md) |
| 宝石 | `demo_amethyst_gem` | [宝石孔](宝石孔.md) |
| 食物 | food.yml 各项 | [物品定义 → food](物品定义.md#3-options-选项段) |
...
- [物品定义](物品定义.md)：字段全解
- [动作系统](动作系统/概览.md)：触发器 + 处理器
- [内置内容清单](../05-参考/内置内容清单.md)：内置品质 / 段 / 套装全表
