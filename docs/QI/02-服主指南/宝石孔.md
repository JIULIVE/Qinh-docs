...
> 所属：[服主指南](物品定义.md)　·　相关：[物品定义](物品定义.md) · [集成](../04-开发者/集成.md)
...
也可用 GUI 编辑（见 [其他编辑器 → 宝石孔](../03-编辑器GUI/其他编辑器.md)）。
...
- [灵魂绑定](灵魂绑定.md)：绑定物品保护
- [集成](../04-开发者/集成.md)：Legendinlay / MagicGem 桥接内部
