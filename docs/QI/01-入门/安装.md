...
> 上一页：[概览](概览.md)　·　下一页：[5 分钟快速上手](快速上手.md)
...
| 软依赖 | 启用的功能 |
|---|---|
| **AttributePlus** | 物品战斗属性真正作用到玩家（数值后端）。详见 [属性与数值](../02-服主指南/属性与数值.md) |
| **QinhSkills** | 物品动作 `qinhskills:cast` 释放技能。详见 [集成](../04-开发者/集成.md) |
| **PlaceholderAPI** | `%qinhitems_...%` 占位符。详见 [占位符](../05-参考/占位符.md) |
| **Legendinlay** | 宝石孔后端 A。详见 [宝石孔](../02-服主指南/宝石孔.md) |
| **MagicGem** | 宝石孔后端 B |
