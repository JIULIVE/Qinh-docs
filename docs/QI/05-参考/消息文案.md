...
> 所属：[参考](命令.md)　·　相关：[配置文件](配置文件.md) · [灵魂绑定](../02-服主指南/灵魂绑定.md)
...
留空 `lore-format` 则不显示绑定行。见 [灵魂绑定](../02-服主指南/灵魂绑定.md)。
...
见 [套装 → Lore 显示](../02-服主指南/套装.md#6-套装-lore-显示)。

---

## 三、品质显示（item_tiers.yml）

每个 Tier 的 `name`（带颜色显示名）、`unidentification.name`（未鉴定名）、`unidentification.prefix` 都可改。见 [品质与显示](../02-服主指南/品质与显示.md)。
...
见 [品质与显示 → 属性显示标签](../02-服主指南/品质与显示.md#6-属性显示标签) 与 [属性与数值](../02-服主指南/属性与数值.md)。
...
- [配置文件](配置文件.md)：完整配置
- [灵魂绑定](../02-服主指南/灵魂绑定.md) / [套装](../02-服主指南/套装.md)
