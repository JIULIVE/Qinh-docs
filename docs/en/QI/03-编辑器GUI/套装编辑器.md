...
> Belongs to: [Editor GUI](./overview.md)　·　Related: [Set](../02-server-guide/sets.md)
...
For the meaning of these fields, see [Set](../02-server-guide/sets.md#1-数据模型).
...
- [Set](../02-server-guide/sets.md): set mechanics and YAML
- [Action Editor](./action-editor.md): the handlers used by set abilities
