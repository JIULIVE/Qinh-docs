...
> Belongs to: [Editor GUI](概览.md)　·　Subpages: [Item Editor](物品编辑器.md) · [Action Editor](动作编辑器.md) · [Set Editor](套装编辑器.md) · [Other Editors](其他编辑器.md)
...
- **Opaque action payloads**: QI does not interpret handler payloads, but if a handler registers a [payload schema](../04-开发者/动作处理器开发.md#payload-schema), the GUI generates a form with typed fields.
...
- [Item Editor](物品编辑器.md)
- [Action / Skill Editor](动作编辑器.md)
- [Set Editor](套装编辑器.md)
- [Templates / Other Sub-editors](其他编辑器.md)
