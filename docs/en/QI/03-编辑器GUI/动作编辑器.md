...
> Belongs to: [Editor GUI](概览.md)　·　Related: [Action System](../02-服主指南/动作系统/概览.md) · [Item Editor](物品编辑器.md)
...
The payload schema is the field structure that the developer declares for a handler; see [Action Handler Development → payload schema](../04-开发者/动作处理器开发.md#payload-schema) for details.
...
For the skill mechanism, see [Integration → QinhSkills](../04-开发者/集成.md).
...
What you configure in the GUI is exactly the `actions.triggers` from the [Action System](../02-服主指南/动作系统/概览.md):
...
- [Action System](../02-服主指南/动作系统/概览.md): underlying concepts
- [Handlers](../02-服主指南/动作系统/处理器.md): handlers and payload
- [Action Handler Development](../04-开发者/动作处理器开发.md): custom handlers + schema
