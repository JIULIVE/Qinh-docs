...
> Belongs to: [Server Owner Guide](./item-definition.md)　·　Related: [Quality & Display](./quality-display.md) · [Fragments & Templates](./fragments-templates.md)
...
Declare in the item's (or [fragment](./fragments-templates.md)'s) `variables:` section. The key is the variable name, the value is a **range** or **static string**:
...
| `soulbound.owner` | Set on soulbinding, see [Soulbinding](./soulbinding.md) |
...
Via the facade `QinhItemsAPI.variables()` (see [API Reference](../04-developer/api-reference.md)):
...
- [Affixes](./affixes.md) / [Sections](./sections.md): use pooled text for prefixes and suffixes
- [Fragments & Templates](./fragments-templates.md): reuse variable declarations
- [API Reference](../04-developer/api-reference.md): full signatures of the variables facade
