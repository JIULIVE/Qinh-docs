...
> Belongs to: [Server Owner Guide](物品定义.md)　·　Related: [Variables](变量.md) · [Layers and Assembly](../04-开发者/层与装配.md)
...
Fragments / items can declare custom models; see [Resource Packs](资源包.md) for details. The `resource_pack` section is ultimately compiled into a `ResourcePackDeclaration`.
...
When not explicitly configured, it is auto-generated from `QinhItemTypeRegistry` by `library-category`. For developer details see [Layers and Assembly](../04-开发者/层与装配.md).

---

## Next Steps

- [Variables](变量.md): declare reusable variables inside fragments
- [Resource Packs](资源包.md): custom models
- [Layers and Assembly](../04-开发者/层与装配.md): inside templates / assembly
