...
> Belongs to: [Server Owner Guide](物品定义.md)　·　Related: [Item Definition](物品定义.md) · [Configuration File](../05-参考/配置文件.md)
...
It is rendered by the "Soulbinding" segment of the [structured Lore](品质与显示.md#5-lore-段顺序从上到下), reading the variables `soulbound.owner` / `soulbound.level`.
...
> 💡 **For market / mail plugin authors**: Check `isSoulbound` before listing / mailing; bound items should not be traded. See [API Reference](../04-开发者/API参考.md).

---

## Next Steps

- [Enchantment Cap](附魔上限.md)
- [API Reference](../04-开发者/API参考.md): binding-related API
