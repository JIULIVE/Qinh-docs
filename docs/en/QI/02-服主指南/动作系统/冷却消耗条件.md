...
> Belongs to: [Action System](概览.md)　·　Related: [Triggers](触发器.md) · [Handlers](处理器.md)
...
> ⚠️ Conditions can only do these **preset checks**; you cannot write arbitrary logic expressions. For complex checks, [develop a handler](../../04-开发者/动作处理器开发.md) and decide in code.
...
- [Triggers](触发器.md): all trigger atoms
- [Handlers](处理器.md): all action handlers
- [Action Handler Development](../../04-开发者/动作处理器开发.md): custom logic
