...
> Belongs to: [Action System](概览.md)　·　Related: [Handlers](处理器.md) · [Cooldown / Cost / Conditions](冷却消耗条件.md)
...
> 📋 Want a **copy-and-use minimal YAML** for each category of trigger? See [Trigger Hands-On Examples](触发器实战.md).
...
See [Cooldown / Cost / Conditions / Combos](冷却消耗条件.md#4-序列连招与双击) for details.

---

## Next Steps

- [Handlers](处理器.md): what to execute after a trigger fires
- [Cooldown / Cost / Conditions](冷却消耗条件.md): restrict triggers
