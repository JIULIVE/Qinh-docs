...
> Belongs to: [Server Owner Guide](./item-definition.md)　·　Related: [Item Definition](./item-definition.md) · [Item Types](./item-types.md) · [Action System](./action-system/overview.md)
...
- **[Examples - Equipment](./cookbook-equipment.md)** —— Armor / Helmet / Chestplate / Leggings / Boots / Bow / Crossbow / Trident / Ammunition / Shield / Wand / Horse Armor (47 items)
- **[Examples - Accessories & Consumables](./cookbook-accessories-consumables.md)** —— Accessory / Ring / Necklace / Bracelet / Food / Scroll / Seed / Bait / Material / Tool / Fishing Rod (41 items)
- **[Examples - Misc](./cookbook-misc.md)** —— Currency / Token / Trophy / Skull / Prop / Mount (22 items)
...
Only an interactive "playable" gem adds `left_click` (see `demo_radiant_gem`). For the gem socket system, see [Gem Sockets](./gem-sockets.md).
...
```
> With the same `quality_prefix_pool` section, `epic_sword`/`rare_sword`/`uncommon_sword` show different prefixes because of their different tiers. For section definitions, see [Sections](./sections.md) and [Built-in Content List](../05-reference/bundled-content.md).
...
```
See [Enchant Cap](./enchant-caps.md).
...
```
For set definitions, see [Sets](./sets.md) and [Built-in Content List](../05-reference/bundled-content.md#套装).
...
| Cast a skill on left-click | `demo_thunder_edge` | [Action System](./action-system/overview.md) |
| On-hit / on-kill trigger | `demo_warden_greatsword` | [Triggers](./action-system/triggers.md) |
| Drink a potion to trigger a buff | `demo_berserk_brew` | This page §3 |
| Scroll / one-time consumable | `demo_recall_scroll` | This page §3 |
| Equip / unequip trigger | `demo_sunfire_emblem` (accessory) | [Triggers](./action-system/triggers.md) |
| Random prefix / affix | `random_affix_weapon` / `legendary_sword` | [Sections](./sections.md) / [Affixes](./affixes.md) |
| Set | `warrior_*` / `mage_*` | [Sets](./sets.md) |
| Bound item | `demo_warden_greatsword` | [Soul Binding](./soulbinding.md) |
| Gem | `demo_amethyst_gem` | [Gem Sockets](./gem-sockets.md) |
| Food | items in food.yml | [Item Definition → food](./item-definition.md#3-options-选项段) |

---

## Next Steps

- [Item Definition](./item-definition.md): full field reference
- [Action System](./action-system/overview.md): triggers + handlers
- [Built-in Content List](../05-reference/bundled-content.md): full tables of built-in qualities / sections / sets
