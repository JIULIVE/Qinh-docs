...
> Belongs to: [Server Admin Guide](./item-definition.md)　·　Related: [Item Definitions](./item-definition.md) · [Integrations](../04-developer/integration.md)
...
You can also edit via the GUI (see [Other Editors → Gem Sockets](../03-editor-gui/other-editors.md)).
...
For the full list of placeholders, see [Placeholders](../05-reference/placeholders.md).
...
For bridge details, see [Integrations](../04-developer/integration.md).
...
- [Soul Binding](./soulbinding.md): bound-item protection
- [Integrations](../04-developer/integration.md): Legendinlay / MagicGem bridge internals
