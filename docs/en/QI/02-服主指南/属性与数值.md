...
> Belongs to: [Server Owner Guide](./item-definition.md)　·　Related: [Core Concepts](../01-getting-started/core-concepts.md) · [Configuration File](../05-reference/config.md)
...
- A Set can also provide perm effects; see [Set](./sets.md).
...
For a complete example of plugging in a custom attribute system, see [Providers & Bridges](../04-developer/providers-bridges.md) and [API Reference](../04-developer/api-reference.md).

---

## Next Step

- [Variables](./variables.md): random numbers, dynamic text
- [Set](./sets.md): set attributes / effects / skills
- [Configuration File](../05-reference/config.md): full config for combat / attribute-mapping
