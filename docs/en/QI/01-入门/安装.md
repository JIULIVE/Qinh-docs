...
> Previous: [Overview](./overview.md)　·　Next: [5-Minute Quick Start](./quick-start.md)
...
|---|---|
| **AttributePlus** | Item combat attributes actually apply to players (numbers backend). See [Attributes & Numbers](../02-server-guide/attributes-numbers.md) |
| **QinhSkills** | `qinhskills:cast` in item actions casts skills. See [Integration](../04-developer/integration.md) |
| **PlaceholderAPI** | `%qinhitems_...%` placeholders. See [Placeholders](../05-reference/placeholders.md) |
| **Legendinlay** | Gem-socket backend A. See [Gem Sockets](../02-server-guide/gem-sockets.md) |
...
Next → [5-Minute Quick Start](./quick-start.md)
