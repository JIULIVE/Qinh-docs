...
> Belongs to: [Reference](./commands.md)　·　Related: [Permissions](./permissions.md)
...
See [Editor GUI](../03-editor-gui/overview.md) for details.
...
For the refresh mechanism, see [Random Generation → Item Refresh Service](../02-server-guide/random-generation.md#7-物品刷新服务).
...
See [Soulbinding](../02-server-guide/soulbinding.md).
...
See [Sections](../02-server-guide/sections.md) / [Affixes](../02-server-guide/affixes.md).
...
See [Random Generation](../02-server-guide/random-generation.md).
...
See [Import & Export](../04-developer/import-export.md).
...
See [Action System](../02-server-guide/action-system/overview.md).
