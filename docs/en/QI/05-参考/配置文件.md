...
> Belongs to: [Reference](命令.md)　·　Related: [Attributes & Values](../02-服主指南/属性与数值.md) · [Soulbound](../02-服主指南/灵魂绑定.md)

Annotation of all `plugins/QinhItems/config.yml` fields. Run `/qi reload` after changes to apply.

> 📄 Want the **full original text + line-by-line annotations**? See [config.yml original line-by-line annotations](配置文件原文.md).
...
Restricts the writable sources of different data domains. See [Layers & Assembly → Write-Domain Policy](../04-开发者/层与装配.md#3-写域策略writedomainpolicy).
...
See [Action System → Design](../02-服主指南/动作系统/概览.md#3-关键设计yaml-里不能写逻辑).
...
See [Attributes & Values](../02-服主指南/属性与数值.md).
...
For full details, see [Soulbound](../02-服主指南/灵魂绑定.md#4-配置项).
...
|---|---|---|
| `item_types.yml` | item types / abilities | [Item Types](../02-服主指南/物品类型.md) |
| `item_tiers.yml` | quality Tiers | [Quality & Display](../02-服主指南/品质与显示.md) |
| `enchant_limits.yml` | enchantment caps | [Enchantment Caps](../02-服主指南/附魔上限.md) |
| `integrations/gem_socket_types.yml` | gem socket types | [Gem Sockets](../02-服主指南/宝石孔.md) |
| `integrations/legendinlay_sockets.yml` | LI socket catalog | [Gem Sockets](../02-服主指南/宝石孔.md) |
| `integrations/magicgem_sockets.yml` | MG socket catalog | [Gem Sockets](../02-服主指南/宝石孔.md) |
| `integrations/bridges.yml` | bridge toggles | [Integration](../04-开发者/集成.md) |
| `integrations/resource_models.yml` | model catalog | [Resource Pack](../02-服主指南/资源包.md) |
