...
> Section: [Reference](命令.md)　·　Related: [Config File](配置文件.md) · [Soulbound](../02-服主指南/灵魂绑定.md)
...
Leave `lore-format` empty to hide the binding line. See [Soulbound](../02-服主指南/灵魂绑定.md).
...
See [Sets → Lore Display](../02-服主指南/套装.md#6-套装-lore-显示).

---

## 3. Tier Display (item_tiers.yml)

Each Tier's `name` (colored display name), `unidentification.name` (unidentified name), and `unidentification.prefix` are all editable. See [Tiers & Display](../02-服主指南/品质与显示.md).
...
See [Tiers & Display → Attribute Display Labels](../02-服主指南/品质与显示.md#6-属性显示标签) and [Attributes & Values](../02-服主指南/属性与数值.md).
...
- [Config File](配置文件.md): full configuration
- [Soulbound](../02-服主指南/灵魂绑定.md) / [Sets](../02-服主指南/套装.md)
