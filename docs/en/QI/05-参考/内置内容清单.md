...
> Belongs to: [Reference](./commands.md)　·　Related: [Quality & Display](../02-server-guide/quality-display.md) · [Section](../02-server-guide/sections.md) · [Set](../02-server-guide/sets.md)

The **complete inventory** of QI's bundled tiers, Sections / affix pools, and Sets, so you can reference them directly or modify them as a starting point. For the item example inventory, see [Item Example Library](../02-server-guide/item-cookbook.md).
...
For the full capacity parameters (base / scale / spread / max-spread), see each Tier definition. For capacity calculation, see [Random Generation](../02-server-guide/random-generation.md#3-容量计算).
...
For the full table of Tier fields, see [Quality & Display](../02-server-guide/quality-display.md#3-tier-字段表).
...
For affix mechanics, see [Affix](../02-server-guide/affixes.md); for Section mechanics, see [Section](../02-server-guide/sections.md).
...
> The matching set-piece items are in `items/misc.yml` (`warrior_*` / `mage_*`); see [Item Example Library](../02-server-guide/item-cookbook.md#五逐类注解--miscyml-综合演示). For Set mechanics, see [Set](../02-server-guide/sets.md).

---

## 5. Bundled Item Types

For the 40+ bundled types and their respective capabilities, see [Item Types → Full List of Bundled Types](../02-server-guide/item-types.md#2-内置类型大全).

---

## 6. Bundled Gem Socket Types

See [Gem Socket](../02-server-guide/gem-sockets.md#2-定义孔类型) (`integrations/gem_socket_types.yml`).

---

## Next Steps

- [Item Example Library](../02-server-guide/item-cookbook.md): ~140 example items
- [Quality & Display](../02-server-guide/quality-display.md) / [Section](../02-server-guide/sections.md) / [Set](../02-server-guide/sets.md)
