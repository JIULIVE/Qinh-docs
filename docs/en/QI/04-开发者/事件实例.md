...
> Belongs to: [Developer](./api-overview.md)　·　Related: [Event Reference](./events.md) · [API Recipes](./api-recipes.md)

[Event Reference](./events.md) lists the signatures; this page gives each event one **complete, usable listener** (Java), with a typical use case.
...
Cancellable (`setCancelled`). Can also hook in via `QinhBridgeHook`, see [Provider and Bridge](./providers-bridges.md).
...
- [Event Reference](./events.md): field signatures
- [API Recipes](./api-recipes.md): finished code
