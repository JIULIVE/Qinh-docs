...
> Belongs to: [Developer](API概览.md)　·　Related: [Commands](../05-参考/命令.md)

QI supports **importing** items from MMOItems / NeigeItems, as well as packing content into `.qipack` for **export / import**.

> 🧭 Want the **full migration steps + field mapping reference table + dry-run interpretation**? See [Import / Export Hands-on Manual](导入导出实操.md).
...
Convert the import mapping result into [sections](../02-服主指南/段.md) / [affixes](../02-服主指南/词缀.md), and register them into the layer system.

---

## Next Steps

- [Commands](../05-参考/命令.md): Full list of import / export commands
- [Layers & Assembly](层与装配.md): Layer snapshots
