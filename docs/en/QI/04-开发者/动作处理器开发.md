...
> Belongs to: [Developer](API概览.md)　·　Related: [Action System](../02-服主指南/动作系统/概览.md) · [Handlers](../02-服主指南/动作系统/处理器.md)
...
For the GUI editing flow see [Action Editor](../03-编辑器GUI/动作编辑器.md). Codec operations:
...
Server owners compose handlers in YAML, developers tuck the complexity inside handlers. This boundary keeps the configuration fully editable in the GUI — see [Action System Overview → Design](../02-服主指南/动作系统/概览.md#3-关键设计yaml-里不能写逻辑).
...
- [Handler Reference](../02-服主指南/动作系统/处理器.md): reference for built-in handlers
- [Integration](集成.md): how QinhSkills plugs in as a handler
