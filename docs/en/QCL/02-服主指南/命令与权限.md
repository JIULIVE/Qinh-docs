> Previous: [Configuration File](配置文件.md)　·　Next: [Item Source References](物品源引用.md)
...
> 🩺 For the meaning, normal values, and exception handling of each item, see [Diagnostics & Troubleshooting](诊断与排错.md).
...
> See the "Change Effect Method Quick Reference" in [Configuration File](配置文件.md).
...
> 🔗 For GUI definition and development, see [GUI Programming API](../04-开发者/GUI编程API.md).
...
## 📖 Further Reading
- ➡️ Next: [Item Source References](物品源引用.md) — the unified reference syntax most used by server owners
- ⚙️ [Configuration File](配置文件.md) — the boundary between reload and restart
- 🩺 [Diagnostics & Troubleshooting](诊断与排错.md) — understand every line of `/qcl status`
