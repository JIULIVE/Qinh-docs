> Previous: [Commands & Permissions](./commands-permissions.md)　·　Next: [Diagnostics & Troubleshooting](./diagnostics.md)
...
> 🔗 For the complete list of error codes see [Diagnostic Codes](../05-reference/diagnostic-codes.md).
...
> 🩺 For a line-by-line interpretation see [Diagnostics & Troubleshooting](./diagnostics.md).
...
## 📖 Continue reading
- ➡️ Next: [Diagnostics & Troubleshooting](./diagnostics.md) — how to troubleshoot when a reference fails
- 🔗 [Item API](../04-developer/item-api.md) — interfaces such as `ItemManagerAPI.getHookItem(ref)`
- 🔗 [External Plugin Integration · Item Plugins](../03-external-plugins/item-plugins.md) — integration notes for each item plugin
