...
> 🖼️ *(reserved: an in-game screenshot of the `/qcl attr book` attribute panel — suggested `/img/qcl/attr-book.png`)*
...
> 🖼️ *(reserved: a screenshot of the custom "Thorns" attribute in action — shown in item lore or the attribute panel — suggested `/img/qcl/custom-attr.png`)*
