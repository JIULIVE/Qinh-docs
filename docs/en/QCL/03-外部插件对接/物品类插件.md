> Previous: [概览.en.md](概览.md)　·　Next: [方块模型作物.en.md](方块模型作物.md)
> Related: [../02-服主指南/物品源引用.en.md](../02-服主指南/物品源引用.md) · [../04-开发者/物品API.en.md](../04-开发者/物品API.md) · [概览.en.md](概览.md)
...
> 🧷 **Core mental model**: You almost never call a bridge directly. You just write an **item source reference string** (like `mi-SWORD-CUTLASS`), and QCL automatically dispatches to the matching bridge to fetch the item. For the full reference syntax overview see 👉 [../02-服主指南/物品源引用.en.md](../02-服主指南/物品源引用.md).
...
CraftEngine provides not only items but also the placement and recognition of **custom blocks / furniture** — item references live here; for block/furniture capabilities see 👉 [方块模型作物.en.md](方块模型作物.md).
...
- **Developer API**: see [../04-开发者/物品API.en.md](../04-开发者/物品API.md).
...
- 🔗 [../02-服主指南/物品源引用.en.md](../02-服主指南/物品源引用.md) — reference syntax overview, resolution order, vanilla item notation.
- 🧱 [方块模型作物.en.md](方块模型作物.md) — CraftEngine's block/furniture capabilities, ModelEngine, CustomCrops.
- 🧑‍💻 [../04-开发者/物品API.en.md](../04-开发者/物品API.md) — resolving item source references in code.
- 🧩 [概览.en.md](概览.md) — soft dependency + reflection bridge design philosophy, the full plugin matrix.
