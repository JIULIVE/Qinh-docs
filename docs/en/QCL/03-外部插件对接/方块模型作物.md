> Previous: [物品类插件.md](./item-plugins.md)　·　Next: [经济插件.md](./economy-plugins.md)
> Related: [../02-服主指南/自定义方块.md](../02-server-guide/custom-blocks.md) · [../04-开发者/工具集.md](../04-developer/toolkit.md) · [概览.md](./overview-bridge-matrix.md)
...
> 🧰 **Shared foundation**: The "multi-version, multi-signature compatibility" of every bridge on this page is built on top of `ReflectionBridge` / `ReflectionCache` — method signatures across different major versions of the same plugin are matched automatically. For developer details see 👉 [../04-开发者/工具集.md](../04-developer/toolkit.md).
...
CraftEngine's item references (`ce-namespace_id`) are covered in [物品类插件.md](./item-plugins.md). This page focuses on its **block** and **furniture** capabilities.
...
> For how server owners configure custom blocks (drops, behaviors, etc.), see 👉 [../02-服主指南/自定义方块.md](../02-server-guide/custom-blocks.md).
...
If a developer wants to reuse this reflection toolkit in their own code, see 👉 [../04-开发者/工具集.md](../04-developer/toolkit.md).

---

## 📚 Continue reading

- 🧱 [../02-服主指南/自定义方块.md](../02-server-guide/custom-blocks.md) — CustomBlockConfig server-owner configuration.
- 🔧 [../04-开发者/工具集.md](../04-developer/toolkit.md) — ReflectionBridge / ReflectionCache.
- 🎒 [物品类插件.md](./item-plugins.md) — CraftEngine / other plugins' item references.
- 💰 [经济插件.md](./economy-plugins.md) — Integration with three economy backends.
