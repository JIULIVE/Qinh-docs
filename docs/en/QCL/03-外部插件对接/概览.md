> Previous: [../02-服主指南/诊断与排错.md](../02-服主指南/诊断与排错.md)　·　Next: [物品类插件.md](物品类插件.md)
> Related: [物品类插件.md](物品类插件.md) · [方块模型作物.md](方块模型作物.md) · [经济插件.md](经济插件.md) · [../02-服主指南/物品源引用.md](../02-服主指南/物品源引用.md)
...
### 🎒 Items (provide item-fetching capability, paired with [unified item source references](../02-服主指南/物品源引用.md))
...
> These bridges let the corresponding items be referenced by QI / GUI / CustomBlock / API through the **unified reference syntax**. For per-plugin details see 👉 [物品类插件.md](物品类插件.md).
...
> For details see 👉 [方块模型作物.md](方块模型作物.md).
...
> All managed uniformly by `EconomyBridge`, which registers the "installed and enabled" backends in order. For details see 👉 [经济插件.md](经济插件.md).
...
Precisely because of this wrapper layer, a bridge can still find the correct method signature when "different major versions of the same plugin have different class names". For the developer-side details see [../04-开发者/工具集.md](../04-开发者/工具集.md).
...
4. Items: go to [物品源引用.md](../02-服主指南/物品源引用.md) and try referencing with the corresponding prefix; blocks/models/crops: see the corresponding page; economy: configure `economy.default-provider` then verify via a GUI economy action or the API.

---

## 📚 Continue reading

- 🎒 [物品类插件.md](物品类插件.md) — detailed walkthrough of the nine item bridges, reference prefixes, and examples.
- 🧱 [方块模型作物.md](方块模型作物.md) — CraftEngine / ModelEngine / CustomCrops.
- 💰 [经济插件.md](经济插件.md) — comparison of the three backends, auto source selection, config setup.
- 🔗 [../02-服主指南/物品源引用.md](../02-服主指南/物品源引用.md) — overview of the unified item source reference syntax.
- 🔧 [../04-开发者/工具集.md](../04-开发者/工具集.md) — ReflectionBridge / ReflectionCache developer API.
