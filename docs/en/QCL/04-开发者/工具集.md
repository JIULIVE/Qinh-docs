...
> Navigation: [Documentation Home](../README.md) · [Table of Contents](../README.md) · [API Overview](./api-overview.md) · [Module System](./module-system.md) · [Glossary](../05-reference/glossary.md)
...
- [API Overview](./api-overview.md) — the overall map of the public API
- [Module System](./module-system.md) — Module / ModuleManager / diagnostic model
- [Glossary](../05-reference/glossary.md) — terminology
