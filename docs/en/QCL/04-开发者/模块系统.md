...
> Navigation: [Documentation Home](../README.md) · [Contents](../README.md) · [Core Concepts](../01-入门/核心概念.md) · [API Overview](API概览.md) · [Toolkit](工具集.md) · [Glossary](../05-参考/术语表.md) · [Diagnostic Codes](../05-参考/诊断码.md)
...
> Tip: if a bridge module's corresponding soft dependency is not installed, it is skipped via a reflection bridge and marked `NO_HOOK`. This is normal degradation, not an error. See [Diagnostic Codes](../05-参考/诊断码.md) for details.
...
- [Core Concepts](../01-入门/核心概念.md) — Conceptual foundations of modules, bridges, item sources, etc.
- [Toolkit](工具集.md) — General-purpose tool APIs
- [API Overview](API概览.md) — Map of public APIs
- [Diagnostic Codes](../05-参考/诊断码.md) — Health codes and the code tables for each subsystem
