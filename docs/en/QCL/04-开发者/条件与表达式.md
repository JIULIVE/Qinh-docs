> Related: [动作与技能桥.md](动作与技能桥.md) · [API概览.md](API概览.md) · [脚本API.md](脚本API.md) · [../05-参考/术语表.md](../05-参考/术语表.md)
...
Actions decide "what to do", conditions decide "whether to do it", and expressions compute the concrete numbers for actions. The three are usually used together — see [动作与技能桥.md](动作与技能桥.md).
...
- [动作与技能桥.md](动作与技能桥.md) — Action system and cross-module skill contract
- [脚本API.md](脚本API.md) — Scriptable extension capabilities
