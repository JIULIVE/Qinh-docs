> Related: [API概览.md](API概览.md) · [脚本API.md](脚本API.md) · [条件与表达式.md](条件与表达式.md) · [../05-参考/术语表.md](../05-参考/术语表.md)
...
- [条件与表达式.md](条件与表达式.md) — condition checks / expression evaluation that pair with actions
- [脚本API.md](脚本API.md) — scripted extensions
- [API概览.md](API概览.md) — the full picture of QCL's public API
- [../05-参考/术语表.md](../05-参考/术语表.md) — definitions of terms such as QI / QS / handler / payload / trigger
