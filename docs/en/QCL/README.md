...
> 🖼️ **[Image placeholder]** An in-game screenshot showing the `/qcl status` diagnostic output (platform / modules / bridges all green)　·　suggested `/img/qcl/status-overview.png`
