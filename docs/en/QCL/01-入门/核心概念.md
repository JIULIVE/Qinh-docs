> Previous: [Quick Start](快速上手.md)　·　Next: [Configuration File](../02-服主指南/配置文件.md)
...
> 🔢 The smaller the priority, the earlier it loads. Infrastructure (Config / Database / Reflection) comes first, the assembly layer (Assembly) last. See [Module System](../04-开发者/模块系统.md) for details.
...
> 🔌 For how each kind of third party is connected, see [03-External Plugin Integration](../03-外部插件对接/概览.md).
...
> 📖 For the full comparison table of all 10 sources and syntax details, see [ItemSource Reference](../02-服主指南/物品源引用.md).
...
- Health codes make troubleshooting evidence-based (cross-reference [Diagnostic Codes](../05-参考/诊断码.md)).
...
> 🩺 For the troubleshooting workflow, see [Diagnostics & Troubleshooting](../02-服主指南/诊断与排错.md).
...
> 👨‍💻 Developers should depend only on public packages. See [API Overview](../04-开发者/API概览.md) for details.
...
- Next: [Configuration File](../02-服主指南/配置文件.md) — config.yml and the modules section in detail
- [Module System](../04-开发者/模块系统.md) — the Module interface and development
- [ItemSource Reference](../02-服主指南/物品源引用.md) — full comparison of all 10 sources
- [Diagnostics & Troubleshooting](../02-服主指南/诊断与排错.md) — reading health codes
- [API Overview](../04-开发者/API概览.md) — public package vs internal package
