...
> 所属：[服主指南](./item-definition.md)　·　相关：[核心概念](../01-getting-started/core-concepts.md) · [配置文件](../05-reference/config.md)
...
接自定义属性系统的完整示例见 [Provider 与桥](../04-developer/providers-bridges.md) 与 [API 参考](../04-developer/api-reference.md)。

---

## 下一步

- [变量](./variables.md)：随机数值、动态文本
- [套装](./sets.md)：套装属性 / 效果 / 技能
- [配置文件](../05-reference/config.md)：combat / attribute-mapping 全配置
