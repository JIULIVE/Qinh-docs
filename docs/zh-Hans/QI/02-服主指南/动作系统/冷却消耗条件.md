...
> 所属：[动作系统](./overview.md)　·　相关：[触发器](./triggers.md) · [处理器](./handlers.md)
...
> ⚠️ 条件只能做这些**预设判断**，不能写任意逻辑表达式。需要复杂判断请[开发处理器](../../04-developer/handler-development.md)在代码里判。
...
- [触发器](./triggers.md)：全部触发原子
- [处理器](./handlers.md)：全部动作处理器
- [动作处理器开发](../../04-developer/handler-development.md)：自定义逻辑
