...
> 相关：[物品源引用.md](./item-source-references.md) · [外部插件对接 / 方块模型作物.md](../03-external-plugins/blocks-models-crops.md) · [脚本入门.md](./scripting-intro.md)
...
`item_sources` 用的就是 QCL 的**统一物品源引用**（详见 [物品源引用.md](./item-source-references.md)）。列表里**靠前的优先级更高**。
...
- [物品源引用.md](./item-source-references.md) —— `item_sources` 用的统一物品源引用格式（含 `craftengine-` 前缀规则）
- [外部插件对接 / 方块模型作物.md](../03-external-plugins/blocks-models-crops.md) —— CraftEngine 方块/家具/作物的对接细节
- [脚本入门.md](./scripting-intro.md) —— 用脚本驱动自定义方块的取 / 放 / 识别 / 移除
