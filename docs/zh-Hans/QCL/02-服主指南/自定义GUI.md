> 上一页：[配置文件.md](./config.md) · 下一页：[GUI动作与条件速查.md](./gui-actions-conditions.md)
> 相关：[脚本入门.md](./scripting-intro.md) · [经济动作.md](./economy-actions.md) · [GUI编程API.md](../04-developer/gui-api.md) · [FAQ.md](../05-reference/faq.md)
...
> 动作类型完整列表与逐个示例见 **[GUI动作与条件速查.md](./gui-actions-conditions.md)**。
> 经济相关动作（`give_money` / `take_money` / `set_money`）的 value 写法见 **[经济动作.md](./economy-actions.md)**。
> `javascript` 动作让你用脚本写任意逻辑，见 **[脚本入门.md](./scripting-intro.md)**。
...
> 条件类型完整列表、比较符、`negate` 用法与示例见 **[GUI动作与条件速查.md](./gui-actions-conditions.md)**。
...
## 📖 继续阅读
- ➡️ [GUI动作与条件速查.md](./gui-actions-conditions.md) — 所有点击动作 / 显隐条件的逐条示例
- 💰 [经济动作.md](./economy-actions.md) — `give_money` / `take_money` / `set_money` 的完整语法
- 📜 [脚本入门.md](./scripting-intro.md) — 用 `javascript` 写自定义条件与动作
- 🧰 [GUI编程API.md](../04-developer/gui-api.md) — 开发者从代码注册动态数据源
- ❓ [FAQ.md](../05-reference/faq.md) — 常见问题
