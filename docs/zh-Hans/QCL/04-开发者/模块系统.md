...
> 导航：[文档首页](../README.md) · [目录](../README.md) · [核心概念](../01-getting-started/core-concepts.md) · [API 概览](./api-overview.md) · [工具集](./toolkit.md) · [术语表](../05-reference/glossary.md) · [诊断码](../05-reference/diagnostic-codes.md)
...
::: tip 提示
提示：桥接类模块若对应软依赖未安装，会以反射桥方式跳过并标记为 `NO_HOOK`，属正常降级，不算错误。详见 [诊断码](../05-reference/diagnostic-codes.md)。
:::
...
- [核心概念](../01-getting-started/core-concepts.md) — 模块、桥、物品源等概念基础
- [工具集](./toolkit.md) — 通用工具 API
- [API 概览](./api-overview.md) — 对外 API 地图
- [诊断码](../05-reference/diagnostic-codes.md) — 健康码与各子系统码表
